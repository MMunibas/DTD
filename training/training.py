...
# whether or not to retrain the model from an existing file
retrain_model = False
model_parameter_save = "save/"

# to retrain an existing model
# retrain_model = True
# model_parameter_save = "save/NN-seed311-nt800-nv150-12-12-12-15_loss0.2781941_2020-02-26-18-19-58-122"
...
# get all training and validation data sets
X_train, y_train = data.get_train_data()
X_valid, y_valid = data.get_valid_data()

# start the training procedure of the NN
...
with tf.Session() as sess:
    ...
    for epoch in range(n_epochs):
        ...
        # calculate the current models average score
